...
album_builder:
  pdf_export:
    ...
    subtitle: Bali 2026
    cover_photo: input_data/trips/bali/data/beach/photos/IMG_2619.HEIC
    closing_photo: input_data/trips/bali/data/beach/photos/IMG_2623.HEIC
```
...
```text
input_data/trips/bali/curated/06 Album Builder/exports/*.pdf
```
...
```text
input_data/trips/bali/curated/08 Selected Timeline/exports/*.mp4
```
...
```text
input_data/trips/bali/curated/09 Reel Builder/exports/*.mp4
```
...
Current Bali documentary config:
...
```text
input_data/trips/bali/curated/10 Documentary Builder/exports/*.mp4
```

For the current Bali run, the generated documentary is:

```text
input_data/trips/bali/curated/10 Documentary Builder/exports/bali_trip_documentary.mp4
```

The latest render is about 70 minutes long, 1920x1080, H.264/AAC, and assembled from 479 selected timeline/video segments.
